    ...
    class NameAndValue_via_PathBased___::InferenceFrame__
      ...
      def __maybe_autoloaderize
        ...
        if __should_autoloaderize_the_value
          ...
          _path = @_asset_reference.get_node_path
      ...
      def __should_autoloaderize_the_value  # a near copy-paste of #spot-4
        ...
        if @_asset_reference.entry_group.includes_what_is_probably_a_directory
      ...
      def __cache
        @PAIR = @_asset_reference.write_and_produce_pair_ @_the_value, @_const
        NIL
      end
