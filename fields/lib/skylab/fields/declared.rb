module Skylab::Fields
  ...
  module Declared  # see [#003]
    ...
    Touch_const_with_dupe_for___ = -> p, c, mod do
      ...
      end, c, mod, NIL_ # #todo: :+#temporary-to-this-phase MAYBE?
    end
    ...
    class Aspect  # (apprentice/redux of Basic::Field)
