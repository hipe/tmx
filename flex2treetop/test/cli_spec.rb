  ...
  describe "[f2] CLI" do
    ...
    # ->
      ...
      def want_full_help_screen
        ...
        expect( ( 12 .. 17 ) ).to be_include _count
      ...
      it "1    ping simple" do
        ...
        want_no_more_lines
        expect( @exitstatus ).to eql :hello_from_flex2treetop
      end
      ...
      it "2    ping with argument" do
        ...
        invoke 'ping', 'xx'
        want 'helo:(xx)'
        expect( @exitstatus ).to eql :_cheeky_monkey_
      end
      ...
      def __want_all_this
        ...
        _st = sout_serr_line_stream_for_contiguous_lines_on_stream :o

        want_these_lines_in_array_ _st do |y|
          y << %r(\A# Autogenerated by fle)
          y << NEWLINE_
          y << "# from flex name definitions\n"
          y << NEWLINE_
          y << "rule escape__of_lexer__\n"
          y << %r(\A  unicode__of_lexer__ / )
          y << "end\n"
          y << nil  # NOTE stop early
        end

        expect( @exitstatus ).to eql :translated
      end
