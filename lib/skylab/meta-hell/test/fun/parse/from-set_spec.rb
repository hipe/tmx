...
module Skylab::MetaHell::TestSupport::Fun::Parse::FromSet

  ::Skylab::MetaHell::TestSupport::Fun::Parse[ FromSet_TestSupport = self ]
  ...
  describe "Skylab::MetaHell::Fun::Parse::FromSet" do
