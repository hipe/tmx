  ...
  describe "[f2] CLI" do
    ...
    # ->
      ...
      def __expect_all_this
        ...
        _count = @expect_line_scanner.skip_until_before_Nth_last_line 3

        _count.should eql 13

        next_line.should eql "rule _ignore_comments_\n"
        next_line.should match  %r(\A {1,}[\[\] "\\/*^+()]+\n\z)
        next_line.should eql "end\n"
        next_line.should be_nil
      ...
      def result_for_failure_for_expect_stdout_stderr
        Home_::Brazen_::CLI::GENERIC_ERROR
      end
