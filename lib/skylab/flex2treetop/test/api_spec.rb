  ...
  describe "[f2tt] API" do
    ...
    context "verify treetop output - normal case" do
      ...
      it "o" do
        ...
        _API_invoke :translate,
          ...
          * emitters
        expect_info_lines
        @ln_source.change_upstream_scanner_to_open_filehandle outfile.open 'r'
    ...
    context "verify treetop output - wrap in grammar name mono" do
      ...
      it "o" do
        ...
        @ln_source.change_upstream_scanner_to_open_filehandle o.open 'r'
    ...
    context "wrap in bad grammar name" do
      ...
      it "(note it still begins the file :/) x" do
        ...
        expect_no_more_lines
        io = o.open 'r'
        @ln_source.change_upstream_scanner_to_open_filehandle io
