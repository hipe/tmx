...
describe "#{::Skylab::Headless::Parameter} builder: foo_f" do
  ...
  frame do
    ...
    context "when the parameter value is falseish" do
      it "the builder proc will be called (lazily) (once) to initialize it" do
    ...
    context "but when the parameter value is trueish" do
      ...
      it "the builder proc will not be called to initialize it" do
        @num_times.should eql(0)
