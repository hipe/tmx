module Skylab::TanMan
  ...
  module Core::Action::ModuleMethods
    ...
    Callback[ self, :include_digraph_emitter_module_methods ]  # if descedents want to add to
  ...
  module Core::Action::InstanceMethods
    ...
    Callback[ self, :employ_DSL_for_digraph_emitter ]  # we want its generated methods here
    ...
    listeners_digraph Bleeding::EVENT_GRAPH.merge(call_to_action: :all,
                                                           info: :all,
                                                  no_config_dir: :error,
                                                        payload: :all,
                                                           skip: :info )
