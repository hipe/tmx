...
module ::Skylab::PubSub::TestSupport::Emitter::Specificity

  ::Skylab::PubSub::TestSupport::Emitter[ Specificity_TestSupport = self ]
  ...
  describe "[ps] emitter specificity" do
    ...
    context "simple multi-inheritence triangle graph" do
      ...
      #         [H]
        ...
        whence do |a|
          z = PubSub::TestSupport::Fixtures::ZigZag.new
