  ...
  context "(CLI)" do
    ...
    context 'doing nothing' do
      ...
      it 'expecting' do
        ...
        want :e, /\Aexpecting <yacc-file>\z/
      end

      it 'usage & invite' do

        _want_usage_and_invited
      end
    end
    ...
    context 'asking for help' do
      ...
      it 'usage' do
        expect( _index_of( 'usage' ) ).to eql 0
      end

      it 'description' do
        expect( _index_of( 'description' ) ).to eql 2
      end

      it 'options' do
        expect( _index_of( 'options' ) ).to eql 4
      end
    ...
    context 'giving 2 args' do
      ...
      it 'unexpected' do
        ...
        _against _first_line
        want :e, 'unexpected argument "two"'
      end
    ...
    context 'giving it a nonexistant filename' do
      ...
      it 'writes specific complaint, usage, invite to stderr' do
        ...
        want :e, /\ANo such file or directory: [-_\/\.a-zA-Z0-9]+\.yacc\z/
      end
    ...
    context 'giving it a good filename' do
      ...
      it 'writes a treetop grammar to stdout' do
        ...
        want :o, "# Autogenerated from yacc2treetop. Edits may be lost."
        want :o, "rule simple_selector_sequence"
        want :o, "  ( type_selector / universal )"
        want :o, /\A    \( HASH \/ class \//
        want :o, 'end'
        want_no_more_lines
      end
    ...
    it "[tmx] integration (stowaway)", TMX_CLI_integration: true do
      ...
      cli.want_on_stderr "hello from yacc2treetop."
    ...
    def results_in_error_exitstatus_
      expect( invocation_state_.exitstatus ).to match_common_error_code_
    end
    ...
    def results_in_success_exitstatus
      expect( invocation_state_.exitstatus ).to be_zero
    end

    # -- macros (predicates over several lines)

    def _want_usage_and_invited

      expect( _penultimate_line ).to match_ __usage_line
    ...
    def _want_invited
      ...
      expect( _last_line ).to match_ ___invite_line
    end
